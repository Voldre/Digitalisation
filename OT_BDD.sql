...
CREATE TABLE IF NOT EXISTS `OT` (
  ...
  `SIGNATURE_INTERVENANT_DEBUT` varchar(255),
  `SIGNATURE_INTERVENANT_DEBUT_DATE` Datetime,
  `SIGNATURE_INTERVENANT_FIN` varchar(255),
  `SIGNATURE_INTERVENANT_FIN_DATE` Datetime,
  `SIGNATURE_SQO` varchar(255),
  `SIGNATURE_SQO_DATE` Datetime,
  `SIGNATURE_PROPRIO_FIN` varchar(255),
  `SIGNATURE_PROPRIO_FIN_DATE` Datetime,
  `GXP_PARAM_MODIF` boolean,  
  `GXP_PIECES_MODIF` boolean, 
  `GXP_PROG_MODIF` boolean, 
  `GXP_CABLAGE_MODIF` boolean, 
  `GXP_ALL_DONE` boolean, 
  `GXP_CONTROLE` boolean,  
  `GXP_FONCTIONNEL` boolean, 
  `GXP_CAHIER_ROUTE_COMPLET` boolean,  
  `GXP_CAHIER_ROUTE_OBSERV` varchar(255),
  `GXP_IMPACT` boolean
  PRIMARY KEY (`ID`)
